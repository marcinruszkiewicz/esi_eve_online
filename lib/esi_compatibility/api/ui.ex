defmodule ESI.API.UI do
  ...
  This module provides the same interface as the legacy ESI.API.UI module,
  ...
  - `open_contract_window/0` or `open_contract_window/1`
      - `open_market_details_window/0` or `open_market_details_window/1`
      - `open_information_window/0` or `open_information_window/1`
      - `set_autopilot_waypoint/0` or `set_autopilot_waypoint/1`
      - `open_new_mail_window/0` or `open_new_mail_window/1`
  ...
  ESI request pattern:
      ...
      iex> request = ESI.API.UI.some_function(opts)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/User Interface/post_ui_openwindow_contract)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/User Interface/post_ui_autopilot_waypoint)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/User Interface/post_ui_openwindow_newmail)
