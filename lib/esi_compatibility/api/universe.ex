defmodule ESI.API.Universe do
  ...
  @type group_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_groups_group_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_stargates_stargate_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_graphics_graphic_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_categories)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_constellations_constellation_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_planets_planet_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_structures_structure_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_factions)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_moons_moon_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_regions)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_stations_station_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_asteroid_belts_asteroid_belt_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_constellations)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_graphics)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_system_jumps)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Planetary Interaction/get_universe_schematics_schematic_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_systems)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_structures)
  ...
  def structures(opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/universe/structures/",
      opts_schema: %{filter: {:query, :optional}, datasource: {:query, :optional}},
      opts: Map.new(opts)
    }
  end
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/post_universe_ids)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_types)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_stars_star_id)
  ...
  @type region_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_regions_region_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_categories_category_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_groups)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/post_universe_names)
  ...
  @type type_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_types_type_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_ancestries)
  ...
  @type system_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_systems_system_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_bloodlines)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_system_kills)
  ...
  @type races_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Universe/get_universe_races)
