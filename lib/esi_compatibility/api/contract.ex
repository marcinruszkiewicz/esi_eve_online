defmodule ESI.API.Contract do
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Contracts/get_contracts_public_items_contract_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Contracts/get_contracts_public_bids_contract_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Contracts/get_contracts_public_region_id)
