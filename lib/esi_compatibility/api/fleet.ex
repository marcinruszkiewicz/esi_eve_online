defmodule ESI.API.Fleet do
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Fleets/get_fleets_fleet_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Fleets/put_fleets_fleet_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Fleets/delete_fleets_fleet_id_squads_squad_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Fleets/put_fleets_fleet_id_squads_squad_id)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Fleets/get_fleets_fleet_id_members)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Fleets/post_fleets_fleet_id_members)
