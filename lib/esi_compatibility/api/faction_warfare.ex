defmodule ESI.API.FactionWarfare do
  ...
  This module provides the same interface as the legacy ESI.API.FactionWarfare module,
  ...
  - `stats/0` or `stats/1`
      - `wars/0` or `wars/1`
      - `leaderboards_corporations/0` or `leaderboards_corporations/1`
      - `systems/0` or `systems/1`
      - `leaderboards_characters/0` or `leaderboards_characters/1`
      - `leaderboards/0` or `leaderboards/1`
  ...
  ESI request pattern:
      ...
      iex> request = ESI.API.FactionWarfare.some_function(opts)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Faction Warfare/get_fw_stats)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Faction Warfare/get_fw_wars)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Faction Warfare/get_fw_leaderboards_corporations)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Faction Warfare/get_fw_systems)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Faction Warfare/get_fw_leaderboards_characters)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Faction Warfare/get_fw_leaderboards)
