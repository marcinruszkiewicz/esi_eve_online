defmodule ESI.API.Faction_warfare do
  @moduledoc """
  Legacy compatibility module for Faction_warfare API endpoints.

  This module provides the same interface as the legacy ESI.API.Faction_warfare module,
