defmodule Esi.Api.CorporationsCorporationIdWalletsDivisionJournalGet do
  @moduledoc """
  Provides struct and type for a CorporationsCorporationIdWalletsDivisionJournalGet
  """
