if Code.ensure_loaded?(OpenAPI.Processor) do
  defmodule Esi.CustomProcessor do
    ...
    This module is used by the `oapi_generator` library to customize the
    generated API modules. It's responsible for creating semantic function
    names and organizing the generated code.

    This module is only used during development for API code generation and is
    ...
    def operation_module_names(_state, operation) do
      ...
      base_module = parts |> List.first() |> Macro.camelize()
