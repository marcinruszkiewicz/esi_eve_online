defmodule Integration.ApiIntegrationTest do
  ...
  describe "generated API modules integration" do
    test "Alliance API works with client" do
      ...
      mock_response = %Req.Response{
        status: 200,
        body: %{
          "creator_corporation_id" => 98356193,
      ...
      with_mock Req, [request: fn(_opts) -> {:ok, mock_response} end] do
        ...
        assert {:ok, alliance_data} = Esi.Api.Alliances.alliance(99005443)
    ...
    test "Fleet invite special case" do
      ...
      with_mock Req, [request: fn(_opts) -> {:ok, mock_response} end] do
        ...
        assert_called Req.request([
          ...
          json: %{"character_id" => 1234567890, "role" => "squad_member"},
          headers: [
    ...
    test "Error handling in generated modules" do
      ...
      with_mock Req, [request: fn(_opts) -> {:ok, mock_response} end] do
        # Test error response
        assert {:error, error} = Esi.Api.Alliances.alliance(99999999)
    ...
    test "Singular/plural naming works correctly" do
      ...
      mock_response = %Req.Response{
        status: 200,
        body: [6, 7, 8, 9, 10, 11, 16, 17, 18, 20, 22, 23, 25, 29, 32, 34, 35, 39, 40, 41, 42, 43, 46, 63, 65, 66, 87, 91],
        headers: []
      }
  ...
  describe "unified interface integration" do
    test "EsiEveOnline.get/2 works end-to-end" do
      mock_response = %Req.Response{
        status: 200,
        body: %{"players" => 25000, "server_version" => "1234567", "start_time" => "2023-01-01T12:00:00Z"},
        headers: []
      }
